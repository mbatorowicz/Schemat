...
export const W = {
  ...
  fieldTip: {
    ...
    leadLength: "D\u0142ugo\u015b\u0107 przy\u0142\u0105cza (min. krok siatki). Enter zatwierdza.",
    leadDir: "Kierunek zewn\u0119trzny przy\u0142\u0105cza: N / E / S / W.",
    ...
    connSignal: "Sygna\u0142 / potencja\u0142 sieci (L, N, PE, +24V\u2026).",
    connWire: "Typ przewodu / oznaczenie BOM (np. LgY 1×1,5) — nie kolor linii.",
    connLength: "D\u0142ugo\u015b\u0107 przewodu (r\u0119cznie, np. 2.5 m).",
    connNotes: "Uwagi do po\u0142\u0105czenia.",
    wireMarkMode:
      "Konwencja nadruku na ko\u0144cach trasy: lokalny (ten koniec), drugi koniec (dok\u0105d idzie), sk\u0105d\u2013dok\u0105d (oba na ka\u017cdej koszulce).",
    wireMarkLocal: "Przy ko\u0144cu wida\u0107 oznaczenie tego zacisku (np. -F1:2).",
    wireMarkOther: "Przy ko\u0144cu wida\u0107 oznaczenie drugiego ko\u0144ca (np. przy F1:2 \u2192 -G1:L).",
    wireMarkBoth: "Na obu ko\u0144cach pe\u0142ne sk\u0105d\u2013dok\u0105d (np. -F1:2 / -G1:L).",
  },
  dialog: {
  ...
  chrome: {
    ...
    promote: "Do spisu",
    promoteTip: "Zapisz zaznaczoną linię jako połączenie w spisie",
    fileMenu: "Plik",
    shortcuts: "Skróty",
    shortcutsTip: "Skróty klawiszowe (?)",
    assistant: "AI",
    assistantTip: "Pomocnik AI — normy, symbole, sprawdzenie arkusza",
  },
  assistant: {
    title: "Pomocnik AI",
    button: "AI",
    buttonTip: "Pomocnik AI — normy, symbole, sprawdzenie arkusza",
    disclaimer:
      "Arkusz i spis idą do modelu (Vercel AI Gateway), żeby sprawdzić zgodność z normami. To nie zastępuje oficjalnego tekstu EN/IEC.",
    placeholder: "Pytanie o symbol, oznaczenie albo zgodność z normą…",
    send: "Wyślij",
    ...
    error: "Pomocnik nie odpowiedział.",
    empty: "Brak odpowiedzi.",
    close: "Zamknij pomocnika",
  },
  draw: {
    line: "Linia",
    lineLong: "Linia / łamana",
    rect: "Prostokąt",
    circle: "Koło",
    arc: "Łuk",
    text: "Tekst",
  ...
  drawHint: {
    ...
    point: "Punkt styku: kliknij miejsce zacisku · Esc = anuluj.",
    node: "Węzeł: kliknij miejsce · Esc = anuluj.",
    lead: "Przyłącze: klik = początek na obudowie, klik = koniec styku · Esc = anuluj.",
